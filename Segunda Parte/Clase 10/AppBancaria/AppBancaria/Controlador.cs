...
namespace AppBancaria
{
    internal class Controlador
    {
        ...
        public bool agregarCuenta(ulong CBU, string Cliente, float Saldo,string planCuenta, ulong tarjetaVinculada)
        {
            if(Buscar(CBU)==null)
            {
                Listadocuentas.Add(new CajaAhorro(CBU, Cliente,Saldo,planCuenta,tarjetaVinculada));
                return true;
            }
            return false;
        }
        public bool agregarCuenta(ulong CBU, string Cliente, float Saldo, float interesDescubierto)
        {
            if (Buscar(CBU) == null)
            {
                Listadocuentas.Add(new CuentaCorriente(CBU, Cliente, Saldo, interesDescubierto));
                return true;
            }
            return false;
        }
        public bool deposito(ulong CBU,float depositar)
        {
            ...
            {
                return CuentaEncontrada.depositar(depositar);
            }
            return false;
        }
        public bool extraccion(ulong CBU, float extraccion)
        {
            ...
            if(CuentaEncontrada != null)
            {
                return CuentaEncontrada.extraer(extraccion);
            }
            return false;
        }
