...
namespace AppBancaria
{
    internal class Interfaz
    {
        ...
        public static int darTipoCuenta()
        {
            Console.Clear();
            Console.Write("-----------------------------------\n");
            Console.WriteLine("- Sistema de Gestion De Cuentas -");
        ...
        public static string LeerMensaje_getstring(string str)
        {
            Console.Clear();
            Console.Write("-----------------------------------\n");
            Console.WriteLine("- Sistema de Gestion De Cuentas -");
        ...
        public static ulong LeerMensaje_getulong(string str)
        {
            Console.Clear();
            Console.Write("-----------------------------------\n");
            Console.WriteLine("- Sistema de Gestion De Cuentas -");
        ...
        public static float LeerMensaje_getfloat(string str)
        {
            Console.Clear();
            Console.Write("-----------------------------------\n");
            Console.WriteLine("- Sistema de Gestion De Cuentas -");
